...
CREATE TABLE
    ...
    ) ENGINE = InnoDB AUTO_INCREMENT = 53 DEFAULT CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE
    IF NOT EXISTS `first_test`.`CATEGORY` (
        ...
        CONSTRAINT `fk_CATEGORY_SUPERCATEGORY1` FOREIGN KEY (`Super`) REFERENCES `first_test`.`SUPERCATEGORY` (`Name`) ON DELETE CASCADE ON UPDATE CASCADE
    ) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE
    IF NOT EXISTS `first_test`.`CATEGORY_ASSIGN` (
        ...
        CONSTRAINT `fk_CATERGORY_ASSIGN_CATEGORY1` FOREIGN KEY (`Category`) REFERENCES `first_test`.`CATEGORY` (`Name`) ON DELETE CASCADE ON UPDATE CASCADE,
        CONSTRAINT `fk_CATERGORY_ASSIGN_PRODUCT1` FOREIGN KEY (`SN`) REFERENCES `first_test`.`PRODUCT` (`SN`) ON DELETE CASCADE ON UPDATE CASCADE
    ) ENGINE = InnoDB DEFAULT CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE
    IF NOT EXISTS `first_test`.`PARCEL` (
...
CREATE TABLE
    IF NOT EXISTS `first_test`.`USERORDER` (
        `Email` VARCHAR(45) NOT NULL,
        `SN` INT NOT NULL,
        `Amount` INT NOT NULL,
        `NR` INT NOT NULL AUTO_INCREMENT,
        ...
        CONSTRAINT `fk_USERORDER_PARCEL1` FOREIGN KEY (`PARCEL`) REFERENCES `first_test`.`PARCEL` (`NR`)
    ) ENGINE = InnoDB AUTO_INCREMENT = 33 DEFAULT CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
